...
const NavBar: React.FC = () => {
  ...
  // Get ETH address from user metadata or the local wallet email generated by the Edge Function.
  const emailWalletAddress = user?.email?.match(/^(0x[a-fA-F0-9]{40})@metamask\.local$/)?.[1] ?? null;
